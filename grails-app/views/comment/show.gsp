		...
		<div id="show-comment" class="content scaffold-show" role="main">
			...
			<ol class="property-list comment">
				...
				<li class="fieldcontain">
					<span id="commenter-label" class="property-label"><g:message code="comment.commenter.label" default="Commenter" /></span>
					
						<span class="property-value" aria-labelledby="commenter-label"><g:fieldValue bean="${commentInstance}" field="commenter"/></span>
