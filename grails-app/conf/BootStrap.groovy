...
class BootStrap {
    ...
    def init = { servletContext ->
		...
		def userRole = Role.findByAuthority('ROLE_ADMIN') ?: new Role(authority: 'ROLE_USER', description: 'Users of the blog').save(failOnError: true)
		...
		if(!blogUser.authoriteis.contains(userRole)) {
